...
# Please track changes to your script using version control. Include in your 
#homework the URL to your completed homework assignment available on your GitHub repository

#Git Repository 
https://github.com/c00289089/Repo1.git
...
#1) Using the spread() function, please create a data frame that shows the total 
#number of home runs (HR) for each birthYear for each team (use the teamID 
#column) aggregated by player
